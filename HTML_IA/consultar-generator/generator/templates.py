...
def _construir_datos_js(config: ConfiguracionApp) -> dict:
    ...
    return {
        ...
        "mensajes": {
            ...
            "truncada": config.ui.mensaje_truncada,
        ...
        "adjuntos": {
            "activo": config.adjuntos.activo,
            "formatosPermitidos": config.adjuntos.formatos_permitidos,
            "tamanoMaximoMb": config.adjuntos.tamano_maximo_mb,
            "caracteresMaximosTotales": config.adjuntos.caracteres_maximos_totales,
        },
        "guardarPrompts": {
            "activo": config.guardar_prompts.activo,
            "nombreArchivoPorDefecto": config.guardar_prompts.nombre_archivo_por_defecto,
        },
    }
